...
: ${AMENT_CURRENT_PREFIX:="/home/pjp2/adrc_mimo_ws/install/mimo_adrc"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mimo_adrc/environment/library_path.sh"
